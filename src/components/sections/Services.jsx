...
const Services = () => {
  const services = [
    {
      icon: <Code2 size={32} className="text-[#00eeff]" />,
      title: "UI/UX Design",
      desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur possimus voluptate iste temporibus impedit reiciendis.",
    },
    {
      icon: <Crop size={32} className="text-[#00eeff]" />,
      title: "Web Design",
      desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur possimus voluptate iste temporibus impedit reiciendis.",
    },
    {
      icon: <Apple size={32} className="text-[#00eeff]" />,
      title: "App Design",
      desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur possimus voluptate iste temporibus impedit reiciendis.",
    },
  ];
  ...
  return (
    <section
      id="services"
      className="w-full bg-[#020617] py-16 md:py-20 px-4 sm:px-6 md:px-12 lg:px-20 flex flex-col items-center"
    >
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="max-w-[1400px] w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
        {services.map((service, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 30 }}
            ...
            whileHover={{ y: -8 }}
            viewport={{ once: true }}
            className="group relative bg-[#0f172a] p-6 sm:p-8 md:p-10 rounded-2xl md:rounded-3xl border-2 border-transparent hover:border-[#00eeff] transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:shadow-[0_0_30px_rgba(0,238,255,0.3)] flex flex-col items-center text-center"
          >
            ...
            <button className="px-6 sm:px-8 py-2.5 bg-[#00eeff] text-black font-bold rounded-full shadow-[0_0_15px_#00eeff] hover:shadow-[0_0_30px_#00eeff] transition-all duration-300 active:scale-95">
              Learn More
            </button>
          </motion.div>
        ))}
